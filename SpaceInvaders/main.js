$(document).ready(function(){
  ...
  */
  ...
  if (keyPressed.indexOf(68) != -1){
    ...
    for(let i = 0; i < bullets.lenghth ; i++  ){
      ...
      for(let j = 0; j < aliens.length; j++){
        ...
        if(Colliding(aliens, bullet) && bullet.speed_y < 0){
          ...
          switch(aliens.length){
            ...
            case 15: levelFrame = 20; break;
            case 10: levelFrame = 15; break;
            case 5: levelFrame = 10; break;
            case 1: levelFrame = 5; break;
    ...
    if (Math.random() < 0.02 && aliens.length > 0){
      ...
      bullets.push(new Bullet(alien.x + aliens.width*0.5, alien.y + alien.height, 4, 2, 4, "#FFF000"));
    }
